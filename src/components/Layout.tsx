...
import Sidebar from "@/components/Sidebar"; // Asigură-te că calea este corectă
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1">
        <div className="flex items-center justify-center p-4 bg-gradient-to-br from-primary/10 via-background to-secondary/10">
